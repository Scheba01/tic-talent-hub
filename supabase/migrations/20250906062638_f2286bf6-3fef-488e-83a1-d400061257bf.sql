-- Fix security vulnerability: Restrict candidate data insertion to authenticated users only

-- Update all candidate-related table INSERT policies to require authentication
